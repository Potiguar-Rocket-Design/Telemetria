...
#------------------------------|
#ESP:
porta = "/dev/tty/USB0" # DEPENDE DO SISTEMA! avalie qual sistema opercaional esta usando (Windows, MAC, Linux, FreeBSD...) e mude essa linha baseado no que esta usando
